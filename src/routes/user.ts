...
router.post(
  ...
  new UserController().sendOtpToUser
);
...
router.get(
  ...
  new UserController().getAmznFlexDetails
);

router.put(
  "/flex-details/update",
  authentication("admin"),
  new FlexValidation().flexDetails(),
  validationSchema,
  new UserController().updateAmznFlexDetails
);

router.put(
  "/flex-details/update-tokens",
  authentication("admin"),
  new FlexValidation().flexTokens(),
  validationSchema,
  new UserController().updateFlexTokens
);

router.put(
  "/update-account-info",
  authentication("admin"),
  new UserController().updateAccountInfo
);

router.post(
  "/approve-account",
  authentication("admin"),
  new UserController().sendAccountSetupMail
);

router.put(
  "/pricing-plan",
  authentication("admin"),
  new UserController().enablePricingPlanPage
);

router.get(
  "/list-by-role",
  authentication("admin"),
  new UserController().fetchUserByRole
);

router.post(
  "/add-user",
  authentication("admin"),
  new UserValidation().addUser(),
  validationSchema,
...
router.put(
  ...
  validationSchema,
  new UserController().updateFlexDetailsByDriver
);
...
router.post("/verify-email", new UserController().VerifyEmail);
